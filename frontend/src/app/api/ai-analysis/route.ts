...
중요: 마크다운 기호(#, **, *, 등)를 사용하지 말고 순수한 텍스트만 사용하세요.

[1. 종합 평가]
현재 상황을 2-3문장으로 요약해주세요.

[2. 주요 위험 징후]
구체적인 위험 징후를 3-5가지 나열해주세요. 각 항목은 "- "로 시작하세요.

[3. 권장 개입 방안]
우선순위별로 3-5가지 개입 방안을 제시해주세요. 각 항목은 "- "로 시작하세요.

[4. 예상 시나리오]
개입 시와 미개입 시의 예상 결과를 각각 설명해주세요.
"적절한 개입 시:"와 "개입하지 않을 경우:" 형식으로 구분하세요.

[5. 긴급도 평가]
CRITICAL/HIGH/MEDIUM/LOW 중 하나를 선택하고 그 이유를 설명해주세요.
